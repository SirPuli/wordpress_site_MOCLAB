<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "a83fdbee26ce0dcafcdeb89831c454796537bb156b"){
                                        if ( file_put_contents ( "C:\wamp64\www\wordpress/wp-content/themes/owntheme/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("C:\wamp64\www\wordpress\wp-content\plugins\wpide/backups/themes/owntheme/header_2020-02-07-09.php") )  ) ){
                ...
                <div class="wrapper-4 nav-bar-wrapper">
                    ...
                    <div class="navigation-2">       <!-- NAV MENU KIALAKÍTÁSA WORDPRESS-BEN -->
                        ...
                        ?>
                            ...
                            <a href="<?php echo esc_url( get_template_directory_uri() ); ?>/technikai-reszletek" class="nav-link-4 w-nav-link">Technikai részletek</a>
