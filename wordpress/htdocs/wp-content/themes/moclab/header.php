...
<html data-wf-page="5d37a6b391bed0f41895c73b" data-wf-site="5d37a6b391bed06c6395c73e" <?php language_attributes(); ?>>
    <head>
        ...
        <link href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/go2wire-illu.webflow.css" ref="stylesheet" type="text/css">

        <link href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/normalize.css" ref="stylesheet" type="text/css">

        <link href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/webflow.css" ref="stylesheet" type="text/css">        
    ...
    <div data-collapse="medium" data-animation="default" data-duration="400" class="nav-bar-2 w-nav">
        <div class="wrapper-4 nav-bar-wrapper">
            <a href="index.html" class="brand-2 w-nav-brand w--current"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/moclab.jpg" width="120" alt=""></a>
            <div class="navigation-2">
                <nav role="navigation" class="nav-menu w-nav-menu">
                    <a href="#felhasznalasiterulet" class="nav-link-4 w-nav-link"><?php _e( 'Felhasználási területek', 'moclab' ); ?></a>
                    <a href="<?php echo esc_url( get_template_directory_uri() ); ?>/tech-specs.php" class="nav-link-4 w-nav-link"><?php _e( 'Technikai részletek', 'moclab' ); ?></a>
                    <div class="mobilkapcsolat">
                        <a href="#" class="button-12 w-button"><?php _e( 'Get in touch', 'moclab' ); ?></a>
                    </div>
                </nav>
                <a href="#get-in-touch" class="button-3 small w-hidden-tiny w-button"><?php _e( 'Get in touch', 'moclab' ); ?></a>
