...
<head>
  ...
  <script type="text/javascript">WebFont.load({  google: {    families: ["Open Sans:300,300italic,400,400italic,600,600italic,700,700italic,800,800italic","Droid Sans:400,700","Roboto:100,300,regular,500,700,900"]  }});
  </script>
...
<body>
  <div data-collapse="medium" data-animation="default" data-duration="400" class="nav-bar-2 w-nav">
    <div class="wrapper-4 nav-bar-wrapper">
      <a href="index.php" class="brand-2 w-nav-brand w--current"><img src="/wordpress/wp-content/uploads/2020/02/moclab.jpg" width="120" alt="">
      </a>
